...
VK.requestCredential = function (options, credentialRequestCompleteCallback) {
    ...
    var display = mobile ? 'mobile' : 'popup';
    var scope = '';
    ...
    var loginUrl =
        'https://oauth.vk.com/authorize' +
            ...
            '&scope='     + scope + 
            '&redirect_uri=' + 'https://www.gosportz.tv/_oauth/vk?close=close' + // (config.redirectUri || Meteor.absoluteUrl('_oauth/vk?close=close', {replaceLocalhost: false})) +
            '&response_type=code' +
            '&display=' + display +
